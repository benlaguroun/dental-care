        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="md:w-2/3">
            ...
            <p className="text-xl mb-8">
              ...
              dedicated to your oral health and beautiful smile.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Our clinic is equipped with the latest dental technology for
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Our dentists and staff have years of experience and stay updated
                with the latest dental practices.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                We prioritize your comfort and satisfaction, ensuring a positive
                dental experience every time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Regular check-ups, cleanings, and preventive care to maintain
                your oral health.
              </p>
              <Link
                to="/services#general"
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Enhance your smile with teeth whitening, veneers, and other
                cosmetic procedures.
              </p>
              <Link
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600 mb-4">
                Straighten your teeth with braces or clear aligners for a
                beautiful smile.
              </p>
              <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                "I've been coming to DentalCare for years and have always
                received excellent treatment. The staff is friendly and
                professional, and Dr. Johnson is the best!"
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                "As someone who used to be terrified of dental visits, I can't
                recommend DentalCare enough. They made me feel comfortable and
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600 mb-4">
                "My children love coming to DentalCare! Dr. Davis is amazing
                with kids and makes the whole experience fun and stress-free.
